...
public class AdminAgregarProductoActivity extends AppCompatActivity {
    ...
    ActivityResultLauncher<Intent> tomarFoto = registerForActivityResult(
            ...
            result -> {
                if (result.getResultCode() == Activity.RESULT_OK) {
                    ...
                    uri = Uri.parse(path);
                    Glide.with(AdminAgregarProductoActivity.this).load(bitmap).diskCacheStrategy(DiskCacheStrategy.NONE).skipMemoryCache(true).into(imageView);
                }
            }
    );
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navbar(bottomNavigationView, AdminAgregarProductoActivity.this);
        ...
        ((Button) findViewById(R.id.btnAgregarProducto)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try{
                    ...
                    Toast.makeText(AdminAgregarProductoActivity.this,"El stock debe ser entero",Toast.LENGTH_SHORT).show();
                }
                try{
                    ...
                    Toast.makeText(AdminAgregarProductoActivity.this,"El precio debe ser un numero",Toast.LENGTH_SHORT).show();
                }
                if(uri == null){
                    bool = false;
                    Toast.makeText(AdminAgregarProductoActivity.this,"Debe tomar una foto",Toast.LENGTH_SHORT).show();
                }
                if(bool){
                    ...
                    productos.setId(firebaseFirestore.collection("productos").document().getId());
                    ...
                    firebaseFirestore.collection("productos").document(productos.getId()).set(productos).addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void unused) {
                            Intent intent = new Intent(AdminAgregarProductoActivity.this,AdminListaProductosActivity.class);
